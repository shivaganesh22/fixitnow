...
class FCMv1Sender:
    ...
    def send_message(self, project_id, registration_tokens, notification_title, notification_body):
        results = []
...
def main():
  ...
  "universe_domain": "googleapis.com"
    ...
    PROJECT_ID = 'fixitnow-698b4'
    REGISTRATION_TOKENS = [
        'enIooM_8TRuyrH5MeyL0iR:APA91bFRULC3tfu3tcSx9RJmY8JUna-bKa0652yyJeQt7OyAXYLBcwMFpaz3Vxj9JoOvtG--M8Qf3TJtvqMM6Wz8OZ2raPNia3GFYlSqkcdTim9auNc8uV4',
       
    ]

    fcm_sender = FCMv1Sender(SERVICE_ACCOUNT_JSON)
